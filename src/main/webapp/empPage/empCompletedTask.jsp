            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <a href="user?page=completedtask" class="active"><i class="bi bi-circle"></i><span>Completed</span></a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item">
                                ...
                                <tbody>
                                    ...
                                    %>
                                        <tr>
                                            ...
                                            <td><a href="user?page=taskdetails&id=${emplist.id}" class="badge bg-success">View Details</a></td>
                                        </tr>
                                    <%}%>    
                                    </c:forEach>
