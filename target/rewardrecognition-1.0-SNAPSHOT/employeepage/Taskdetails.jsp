...
<head>
  ...
  <style>
    ...
    .updateButton{font-size:18px;padding:5px 8px;border-radius:4px;
        border:none;cursor: pointer; margin: 20px; background-color: #1CAC78;color: white;}
    .deleteButton{font-size:18px;padding:5px 8px;border-radius:4px;border:none;cursor: pointer; 
        margin: 20px; background-color: #D30000;color: white;}
...
<!--                  Project Details-->
                ...
                <div class="tab-pane fade show active profile-overview" id="project overview">
                  <h5 class="card-title">Tasks Details</h5>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-4 label">Submitted Date:</div>
